...
public class F01_AdaugaNota {
    ...
    @Test
    public void  ECP_invalid_03() throws ClasaException
    {
//        expectedEx.expect(ClasaException.class);
//        expectedEx.expectMessage(Constants.invalidNota);
//        //Nota nota = new Nota(5,898,8);
//        //ctrl.addNota(nota);
    }
    ...
    @Test
    public void  ECP_invalid_06() throws ClasaException
    {
//        expectedEx.expect(ClasaException.class);
//        expectedEx.expectMessage(Constants.invalidNota);
//        Nota nota = new Nota(6.7,"MatematicaMatematicaMatematica",8);
//        ctrl.addNota(nota);
    }
